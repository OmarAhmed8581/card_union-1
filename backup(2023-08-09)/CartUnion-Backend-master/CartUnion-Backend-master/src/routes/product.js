...
const { createProduct, getProductsBySlug, getProductDetailsById, deleteProductById, getProducts, updateProductStatus, rating, review } = require("../controller/product");
